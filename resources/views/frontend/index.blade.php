...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p>This is the homepage of our website. Here you can find various resources and information.</p>
            </div>
        </div>
    </div>
  ...
  <section style="background-image: url('{{ asset('frontend-asset/images/banner-1.jpg') }}');background-repeat: no-repeat;background-size: cover;">
